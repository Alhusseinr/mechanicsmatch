...
function Drawer({ isOpen, onClose, userType, currentPath }: DrawerProps) {
  ...
  const customerMenuItems = [
    ...
    },
    {
      ...
      path: '/customer/saved',
      active: currentPath.includes('/saved')
    },
    {
      id: 'quotes',
      label: 'Quotes',
      ...
      active: currentPath.includes('/quotes')
    },
    {
      id: 'profile',
      label: 'Profile',
  ...
  const mechanicMenuItems = [
    {
      ...
      path: '/shop/dashboard',
      active: currentPath === '/shop/dashboard'
    },
    {
      id: 'bookings',
      label: 'Bookings',
    ...
    },
    {
      ...
      path: '/shop/reviews',
      active: currentPath.includes('/reviews')
    },
    {
      id: 'analytics',
      label: 'Analytics',
    ...
    },
    {
      ...
      path: '/shop/profile',
      active: currentPath === '/shop/profile'
    }
  ];

  const menuItems = userType === 'customer' ? customerMenuItems : mechanicMenuItems;
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-slate-600 capitalize">
                {userType === 'mechanic' ? 'Mechanic Dashboard' : 'Customer Dashboard'}
              </div>
            </div>
          </div>
          <button
